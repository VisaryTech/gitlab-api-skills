...
def build_path(project: str, pipeline_id: str) -> str:
    return f"/api/v4/projects/{encode_component(project)}/pipelines/{pipeline_id}"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Get GitLab pipeline details.")
...
def main() -> int:
    try:
        ...
        result = call_gitlab(base_url, token, build_path(args.project, args.pipeline_id))
        print_result(result)
        return 0
