...
def build_path(project: str, iid: str) -> str:
    return f"/api/v4/projects/{encode_component(project)}/merge_requests/{iid}/changes"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Get GitLab merge request changes.")
